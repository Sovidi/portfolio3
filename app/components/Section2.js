...
function Section2() {
	...
	const skillbox1 = [
		{ id: 1, src: "./assets/js.png", text: "프론트앤드개발을 위한 기본적인 스크립트 구조를 다룹니다.", name:"JavaScript", active: false },
		{ id: 2, src: "./assets/css.png", text: "도큐먼트 디자인을 위한 CSS코드를 다룰 수 있습니다.", name:"CSS3", active: false },
		{ id: 3, src: "./assets/scss.png", text: "심화된 CSS코드인 SCSS를 더 주로 다룹니다.", name:"SCSS", active: false },
		{ id: 4, src: "./assets/html.png", text: "도큐먼트 구조파악과 마크업을 위한 기초부터 심화적 구조를 다룹니다.", name:"HTML5", active: false },
		{ id: 5, src: "./assets/jquery.png", text: "자바스크립트에 더해 다룰 줄 아는 가장 기초적인 보조언어입니다.", name:"jQuery", active: false },
		{ id: 6, src: "./assets/react.png", text: "자바스크립트에 대한 이해도와 더불어 데이터교환의 구조를 파악하고 있으며 여러 프로젝트를 수행하였습니다.", name:"React.js", active: false },
		{ id: 7, src: "./assets/typescript.png", text: "대규모 프로젝트에서 안전성을 구비할 수 있습니다.", name:"TypeScript", active: false },
		{ id: 8, src: "./assets/next.png", text: "리엑트에 대한 이해도와 더불어 서버를 다루는데에 특히 이해도가 높습니다.", name:"Next.js", active: false },
		{ id: 9, src: "./assets/vue.png", text: "기본적인 컨텍스트(store) 이해와 더불어 vue의 각종 독립 훅을 이해하고 능동적으로 다룰 수 있습니다.", name:"Vue.js", active: false }
	];
	const skillbox2 = [
		{ id: 10, src: "./assets/mysql.png", text: "express 와 next.js 에서의 프로젝트로 여러 데이터 교환 구조를 만들어 본 경험이 있습니다.", name:"mySQL", active: false },
		{ id: 11, src: "./assets/express.png", text: "서버사이드 렌더링이 내장된 next.js 를 제외한 리액트와 vue 에서 게이트웨이로 다루어 보았습니다.", name:"Express.js", active: false },
		{ id: 12, src: "./assets/npm.png", text: "프레임워크에서 각종 모듈을 위한 기초적인 모듈로써 모든 구조에서 응용하고 있습니다.", name:"NPM", active: false },
		{ id: 13, src: "./assets/mongodb.png", text: "express 와 더불어 모든 프레임워크에서 주요 명령어를 모듈화시켜 사용하고 있습니다.", name:"MongoDB", active: false },
		{ id: 14, src: "./assets/mariadb.png", text: "mysql 과 더불어 같은 구조로써 서버사이드랜더링 구조를 이해하는데 사용하였습니다.", name:"MariaDB", active: false },
		{ id: 15, src: "./assets/nodejs.png", text: "프론트단과 서버단의 구조연결을 위한 기초적 구조를 알고있습니다.", name:"Node.js", active: false }
	];
	const skillbox3 = [
		{ id: 16, src: "./assets/github.png", text: "각종 프로젝트 버전 공유와 업데이트를 위해 사용할 줄 알고있습니다.", name:"GitHub", active: false },
		{ id: 17, src: "./assets/cloudtype.png", text: "서버사이드렌더링으로 제한적이지만 동적서버를 제공하는 사이트로 몇몇 프로젝트 서버를 위해 사용중입니다.", name:"CloudType", active: false },
		...
		{ id: 21, src: "./assets/figma.png", text: "페이지 사전구상에서 가장 기초적으로 사용하고 있으며 기본적인 디자인 구조를 만들 수 있어요.", name:"Figma", active: false },
