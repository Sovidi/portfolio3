...
function Section2() {
  ...
  return (
    <section className='section section2'>
      ...
      <div className='sec2 overflow-hidden'>
        ...
        <div className='skillIntroduce'>
          <Section2_groups className={selectedItem?.group === 'box1' ? 'z-[10]' : ''} skillbox={skillbox1} setSelectedItem={setSelectedItem} tagId={tagId} idEdit={idEdit} skillsCategory={`Front-End`} />
          <Section2_groups className={selectedItem?.group === 'box2' ? 'z-[10]' : ''} skillbox={skillbox2} setSelectedItem={setSelectedItem} tagId={tagId} idEdit={idEdit} skillsCategory={`Back-End`} />
          <Section2_groups className={selectedItem?.group === 'box3' ? 'z-[10]' : ''} skillbox={skillbox3} setSelectedItem={setSelectedItem} tagId={tagId} idEdit={idEdit} skillsCategory={`ETC`} />
        </div>
      </div>
