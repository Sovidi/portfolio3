...
function Section3() {
  ...
  const workbox = [
    { id: 0, expired: true, name: "Portfolio (Vue.js) *서버폐쇄됨", desc: "Vue.js로 제작된 포트폴리오 페이지 입니다.", src: "./assets/portfolio.gif", skills: "#Vue.js, #scss, #html, #MongoDB, #Express", href: "https://port-0-portfolio2-6w1j2alm48bfok.sel5.cloudtype.app/", githref: "https://github.com/Sovidi/portfolio2" },
    ...
    { id: 7, expired: true, name: "toGrocery (MySQL) *서버폐쇄됨", desc: "시장 농산물 물가현황 간편확인 및 위치기반 매칭 어플", src: "./assets/togrocery.png", skills: "#next.js, #scss, #html, #MySQL", href: "https://togrocery.vercel.app/", githref: "https://github.com/Sovidi/togrocery" },
    ...
    { id: 10, expired: false, name: "웅진 개정수학", desc: "웅진 개정수학 컨텐츠로써, 2학년 2학기 컨텐츠 개발 담당,", src: "./assets/wj_math.png", skills: "#javascript, #css, #html, #jquery", href: "https://wj-revision-math-exported.vercel.app/%EC%96%91%EC%82%B02/2/2-2-3/INDEX3.HTML", githref: "https://github.com/Dalguiee/wj_revision_math_exported" },
    ...
    { id: 11, expired: false, name: "미래엔 고등 중국어", desc: "미래엔 고등과 중등 교과개정 e-book 컨텐츠 개발중 고등 중국어 담당 개발하였습니다.", src: "./assets/miraen_high_china_title.png", skills: "#javascript, #css, #html, #jquery", href: "https://miraen-contents-exported.vercel.app/high/china/contents/lesson02/ops/2/2_01_04.html", githref: "https://github.com/Dalguiee/miraen_contents_exported" },
    { id: 12, expired: false, name: "CGN 통합페이지", desc: "2025년 2월 20주년 기념 CGN 통합페이지 리뉴얼을 맡아 작업하였습니다.", src: "./assets/cgn_intergration.png", skills: "#react.js, #tailwind, #vite, #nest.js", href: "https://cgn-intergration-exported.vercel.app/", githref: "https://github.com/Dalguiee/cgn_intergration_exported" },
  ];
