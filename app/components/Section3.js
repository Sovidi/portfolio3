...
function Section3() {
  ...
  const workbox = [
    ...
    {id: 6, name: "toGrocery", desc: "시장 농산물 물가현황 간편확인 및 위치기반 매칭 어플 (서버폐쇄)", src: "./assets/togrocery.png", skills: "#next.js, #scss, #html, #MySQL", href: "https://togrocery.vercel.app/", githref:"https://github.com/Sovidi/togrocery" },
    {id: 7, name: "toGrocery", desc: "장보러가자의 서버코드를 MongoDB(NoSQL)로 바꾼 버전입니다.", src: "./assets/togrocery.png", skills: "#next.js, #scss, #html, #MongoDB", href: "https://to-grocery2.vercel.app/", githref:"https://github.com/Sovidi/toGrocery2" },
