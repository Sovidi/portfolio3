...
function Section3() {
  ...
  const workbox = [
    ...
    { id: 15, expired: false, name: "2024 Tiving Festa 이벤트 페이지", desc: "Tiving 이벤트 페이지 입니다. 2일 정도의 시간안에 긴급히 배포하게된 프로젝트입니다.", src: "./assets/tving.png", skills: "#javascript, #css, #html, #jquery", href: ["https://dalguiee.github.io/tving_festa2024_exported/"], githref: "https://github.com/Dalguiee/tving_festa2024_exported" },
    ...
    { id: 13, expired: false, name: "미래엔 고등 중국어 e-book 컨텐츠", desc: "미래엔 고등과 중등 교과개정 e-book 컨텐츠 개발중 고등 중국어 담당 개발하였습니다. 중국어 컨텐츠 전체 개발 및 선긋기 게임 컨텐츠를 위한 핵심기능 스크립트 개발 담당했습니다.", src: "./assets/miraen_high_china_title.png", skills: "#javascript, #css, #html, #jquery", href: ["https://miraen-contents-exported.vercel.app/high/china/contents/lesson02/ops/2/2_01_04.html", "https://miraen-contents-exported.vercel.app/high/china/contents/lesson06/ops/6/6_01_08.html", "https://miraen-contents-exported.vercel.app/high/china/contents/lesson07/ops/7/7_01_18.html"], githref: "https://github.com/Dalguiee/miraen_contents_exported" },
    { id: 14, expired: false, name: "CGN 통합페이지", desc: "2025년 2월 20주년 기념 CGN 통합페이지 리뉴얼을 맡아 작업하였습니다. 현재는 운영관리중에 있습니다.", src: "./assets/cgn_intergration.png", skills: "#react.js, #tailwind, #vite, #nest.js", href: ["https://cgn-intergration-exported.vercel.app/"], githref: "https://github.com/Dalguiee/cgn_intergration_exported" },
  ];
