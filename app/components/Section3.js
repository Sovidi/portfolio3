...
function Section3() {
  ...
  const workbox = [
    {id: 0, name: "Portfolio Vue.js", desc: "Vue.js로 제작된 포트폴리오 페이지 입니다.", src: "./assets/portfolio.gif", skills: "#Vue.js, #scss, #html, #MongoDB, #Express", href: "https://port-0-portfolio2-6w1j2alm48bfok.sel5.cloudtype.app/", githref:"https://github.com/Sovidi/portfolio2" },
    ...
    {id: 6, name: "toGrocery", desc: "시장 농산물 물가현황 간편확인 및 위치기반 매칭 어플", src: "./assets/togrocery.png", skills: "#next.js, #scss, #html, #MySQL", href: "https://togrocery.vercel.app/", githref:"https://github.com/Sovidi/togrocery" },
    {id: 7, name: "toGrocery", desc: "서버코드를 MongoDB(NoSQL)로 바꾼 버전입니다.", src: "./assets/togrocery.png", skills: "#next.js, #scss, #html, #MongoDB", href: "https://to-grocery2.vercel.app/", githref:"https://github.com/Sovidi/toGrocery2" },
