        ...
        {skillbox?.map((item) => (
          <>
            ...
            >
              ...
              <div className={`${item.id === tagId ? "opacity-1 brp:translate-x-[0px] max-brp:translate-x-[-50%]" : "opacity-1 max-brp:select-none brp:translate-x-[1000px] max-brp:translate-x-[550%]"}  max-brp:translate-y-[-50%] max-brp:!top-[50%] max-brp:!left-[50%] absolute max-brp:fixed border-[black] popup popclose border-[1px] border-solid`}>
